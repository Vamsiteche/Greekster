...
//Dont follow the code just solve with simple recurrsion. check left subtree num of nodes
// right sub tree number of nodes if even remove the subtree and increase
//answer++ else ignore
// return 1+(left n if it is odd)+(right n if it is odd)
